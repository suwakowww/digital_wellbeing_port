...
print_modname() {
  ui_print "****************************"
  ui_print "   Digital Wellbeing Port   "
  ui_print "   By: suwakowww / 水無月   "
  ui_print "****************************"
}
...
check_install() {
  # Check old version first
  if ! ls system/etc/permissions | grep -aiq 'privapp-permissions-wellbeing.xml'; then
